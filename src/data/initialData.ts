...
export const initialMembers: Member[] = [
  ...
  {
    id: 'user-advisor-osama-mamdouh',
    volunteerId: 'AU-002',
    fullName: 'أسامة ممدوح',
    universityEmail: 'osama.mamdouh@alexu.edu.eg',
    college: 'جامعة الإسكندرية',
    academicYear: 'مستشار الفريق',
    whatsappNumber: '+201000000002',
    birthDate: '1996-05-15',
    age: 29,
    nationalId: '29605150200000',
    currentCommitteeId: 'comm-leadership',
    currentCommitteeName: 'القيادة العليا والمجلس الاستشاري',
    position: 'مستشار فريق متطوعين اتحاد طلاب جامعة الإسكندرية',
    role: 'advisor',
    ...
    committeeHistory: [],
    availability: 'Available',
    bio: 'مستشار فريق متطوعين اتحاد طلاب جامعة الإسكندرية • التوجيه والاستشارات المؤسسية وتطوير القيادات.',
    hobbies: ['التخطيط المؤسسي', 'التدريب القيادي'],
    learningAspirations: ['إدارة الموارد البشرية الاحترافية']
  },
  {
    id: 'user-vp-malak-mohamed',
    volunteerId: 'AU-003',
    fullName: 'ملك محمد',
    universityEmail: 'malak.mohamed@alexu.edu.eg',
    college: 'جامعة الإسكندرية',
    academicYear: 'نائب رئيس الفريق',
    whatsappNumber: '+201000000003',
    birthDate: '2003-08-20',
    age: 22,
    nationalId: '30308200200000',
    currentCommitteeId: 'comm-leadership',
    currentCommitteeName: 'القيادة العليا والمجلس الاستشاري',
